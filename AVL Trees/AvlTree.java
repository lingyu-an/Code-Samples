...
public class AvlTree {
    ...
    // Add a new word or line number in the tree
    public void indexWord(String word, int line) {
        AvlNode node = findNode(word, root);

        // If word doesn't exist already, insert a new node for it
        if (node == null) {
            insert(word);
        }

        // If it does, add the line number to existing node
        node = findNode(word, root);
        node.lineNumber.add(line);
    }

    // Return the list of line numbers in which a word occurs
    ...
    // Prints out the list of unique words in the AVL tree
    ...
    private void printIndex(AvlNode currentNode) {
        ...
        // Recursive call to print entire tree
        System.out.println(currentNode.element + " at line number(s) " + currentNode.lineNumber);
        printIndex(currentNode.left);
        printIndex(currentNode.right);
    }

    // Find the node for a certain word
    private AvlNode findNode(String x, AvlNode n) {
        while (n != null) {
    ...
    private static class AvlNode {
        ...
        AvlNode(String theElement, AvlNode lt, AvlNode rt) {
            ...
            // Linked list variable to keep track to line numbers.
